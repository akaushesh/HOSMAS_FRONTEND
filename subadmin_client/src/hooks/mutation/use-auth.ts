...
export const useLogin = ({
  onSuccess,
  onError,
}: { onSuccess?: (res: AxiosResponse<TokenResponse>) => void; onError?: (err: AxiosError<ErrorResponse>) => void }): UseMutationResult<
...
export const useInitiatePasswordReset = ({
  onSuccess,
  onError,
}: { onSuccess?: (res: AxiosResponse<OkResponse>) => void; onError?: (err: AxiosError<ErrorResponse>) => void }): UseMutationResult<
...
export const useChangePassword = ({
  ...
  ChangePasswordData
> => {
  return useMutation<AxiosResponse<OkResponse>, AxiosError<ErrorResponse>, ChangePasswordData>({ mutationFn: changePassword, onSuccess, onError });
};

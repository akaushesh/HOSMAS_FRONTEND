...
export const metadata = { title: `Hostels | Cleaners | ${config.site.name}` } satisfies Metadata;
    ...
    >
        ...
        <Stack direction='row' alignItems='center' justifyContent='space-between'>
          <Box width={1}>
            ...
            <Typography variant="h4" sx={{ fontSize:{xs:'25px',md:'35px'},color: 'var(--Page-HeadColor)'}} display='inline'>
              Cleaners Assignment
            </Typography>
          </Box>

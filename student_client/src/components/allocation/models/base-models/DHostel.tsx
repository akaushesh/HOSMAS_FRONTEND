...
export default function DHostel(props:ModelProps): React.JSX.Element {
 
  const { nodes, materials } = useGLTF('/r3f/dhostel.glb') as GLTFResult;
  React.useEffect(() => {
  ...
  return (
	<group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.Text001.geometry} material={nodes.Text001.material} position={[2.284, 0.016, -54.512]} rotation={[Math.PI / 2, 0, Math.PI]} scale={6.696} />
      ...
      <mesh geometry={nodes.Text007.geometry} material={materials['Material.007']} position={[-10.532, 0.581, 6.336]} rotation={[Math.PI / 2, 0, 0]} scale={0.768} />
...
useGLTF.preload('/r3f/dhostel.glb');

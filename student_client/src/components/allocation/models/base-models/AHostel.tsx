...
export default function AHostel(props:ModelProps): React.JSX.Element {
 
  const { nodes, materials } = useGLTF('/r3f/ahostel.glb') as GLTFResult;
  React.useEffect(() => {
  ...
  return (
	...
	<mesh geometry={nodes.Text.geometry} material={nodes.Text.material} position={[13.552, 0.016, -10.587]} rotation={[Math.PI / 2, 0, -Math.PI / 2]} scale={6.696} />
	...
	<mesh geometry={nodes.Text002.geometry} material={nodes.Text002.material} position={[-36.149, 0.016, -33.315]} rotation={[Math.PI / 2, 0, 1.588]} scale={6.696} />
	...
	<mesh geometry={nodes.Text007.geometry} material={materials['Material.007']} position={[-10.553, 0.591, 6.336]} rotation={[Math.PI / 2, 0, 0]} scale={0.761} />
...
useGLTF.preload('/r3f/ahostel.glb');

...
export default function QHostel(props:ModelProps): React.JSX.Element {
 
  const { nodes, materials } = useGLTF('/r3f/qhostel.glb') as GLTFResult;
  React.useEffect(() => {
  ...
  return (
	<group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.Cube057.geometry} material={materials['Material.002']} position={[7.345, 10.111, -45.784]} rotation={[Math.PI, -Math.PI / 2, 0]} scale={[-0.046, -2.224, -0.046]} />
      <mesh geometry={nodes.Cube141.geometry} material={materials['Material.002']} position={[-5.389, 5.056, -0.843]} rotation={[0, 0, -Math.PI]} scale={[-0.027, -1.314, -0.027]} />
      <mesh geometry={nodes.Cube142.geometry} material={materials['Material.002']} position={[-19.38, 5.056, -0.843]} rotation={[0, 0, -Math.PI]} scale={[-0.027, -1.314, -0.027]} />
      <mesh geometry={nodes.Cube143.geometry} material={materials['Material.002']} position={[-18.45, 6.946, -46.363]} rotation={[0, 0, -Math.PI]} scale={[-0.037, -1.793, -0.037]} />
      <mesh geometry={nodes.Cube058.geometry} material={materials['Material.002']} position={[5.191, 10.111, -40.436]} rotation={[0, 0, -Math.PI]} scale={[-0.046, -2.224, -0.046]} />
      <mesh geometry={nodes.Cube059.geometry} material={materials['Material.002']} position={[6.633, 10.111, -46.657]} rotation={[0, 0, -Math.PI]} scale={[-0.046, -2.224, -0.046]} />
      ...
      <mesh geometry={nodes.Text002.geometry} material={nodes.Text002.material} position={[-36.149, 0.016, -35.414]} rotation={[Math.PI / 2, 0, 1.588]} scale={6.696} />
      ...
      <group position={[-10.536, 0.527, 6.149]}>
      ...
      <mesh geometry={nodes.Text007.geometry} material={materials['Material.007']} position={[-10.588, 0.565, 6.336]} rotation={[Math.PI / 2, 0, 0]} scale={0.8} />
...
useGLTF.preload('/r3f/qhostel.glb');

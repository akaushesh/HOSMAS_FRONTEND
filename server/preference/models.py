...
class Hostel(models.Model):
    ...
    day_caretaker_name = models.CharField(max_length=200)
    day_caretaker_email = models.EmailField(max_length=200)
    day_caretaker_phone_number = models.CharField(max_length=20)
    
    night_caretaker_name = models.CharField(max_length=200)
    night_caretaker_email = models.EmailField(max_length=200)
    night_caretaker_phone_number = models.CharField(max_length=20)
    ...
    warden_photo = models.URLField(max_length=2000)
